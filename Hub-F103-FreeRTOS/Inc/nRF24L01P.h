...
#define T_CE_GPIO_Port GPIOC
#define R_CE_GPIO_Port GPIOA

#define T_CE_Pin GPIO_BSRR_BS6
#define R_CE_Pin GPIO_BSRR_BS9

#define T_CSN_GPIO_Port GPIOB
#define R_CSN_GPIO_Port GPIOA

#define T_CSN_Pin GPIO_BSRR_BS10
#define R_CSN_Pin GPIO_BSRR_BS10

#define T_IRQ_Pin EXTI_PR_PR12
#define R_IRQ_Pin EXTI_PR_PR11

#define GPIO_PIN_LOW 16
...
#define nRF24_MASK_PWR_UP          0x02  // Mask PWR_UP 
...
uint8_t nRF24_DataReady(SPI_TypeDef* hspi);
