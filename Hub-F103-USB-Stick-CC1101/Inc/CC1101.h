...
#define CC1101_PAYLOAD_LENGTH 58
#define CC1101_BUFFER_LENGTH 64
#define CC1101_ADD_RSSI_LQI 1

#define CC1101_TR_STATE_IDLE 0
#define CC1101_TR_STATE_TX 1
#define CC1101_TR_STATE_RX 2


#define CSN_LOW()      GPIOC->BSRR = GPIO_BSRR_BR13
#define CSN_HIGH()     GPIOC->BSRR = GPIO_BSRR_BS13

extern uint8_t CC1101_HUB_ADDR[CC1101_ADDR_LENGTH];
extern uint8_t CC1101_DEVICE_DISCOVER_ADDR[CC1101_ADDR_LENGTH];
extern uint8_t CC1101_Data[CC1101_BUFFER_LENGTH];
extern volatile uint8_t CC1101_DataLength;
